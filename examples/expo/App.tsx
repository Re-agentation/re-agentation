...
/**
 * Demo screen used for recording the README GIF and for smoke-testing the
 * Re-agentation flow end-to-end.
 *
 * Tap probe button (top-right) → tap any of the cards / header / button →
 * annotate → batch → send.
 */
